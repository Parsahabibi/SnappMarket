...
const CardProductSwiper = ({ bottom, left, title, image, Price, Weight, priceReduction, Discount, width, titleBtn, heightImage, widthImage,normalStyle,hoverStyle }: Props) => {
  ...
  return (
    <Grid display='flex' gap={2} width={width} sx={{ cursor: "pointer" }} style={hover ? hoverStyle : normalStyle} onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}>
