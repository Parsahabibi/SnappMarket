...
import {
  dataStoreSelectoreCard,
  dataStoreSelectoreSendCard,
} from "../../Data/DataMobileStoreSelectoreCard/DataMobileStoreSelectoreCard";
    ...
    <Grid display={{ xs: "flex", sm: "none" }} flexDirection={"column"}>
      ...
      >
        <Grid
          display={"flex"}
          gap={0.5}
          m={"0px 0.4rem 0px 0rem"}
          justifyContent={"center"}
          alignItems={"center"}
        >
          <Typography maxWidth={"13.4rem"} fontSize={"1.4rem"} fontWeight={500}>
            {"اطراف شما"}
          </Typography>
          <Typography>
