...
const data:data[] = [
    ...
    {id:5 ,  image: mosir, name: "ماست چکیده موسیر پر چرب کاله", description: "500 گرم", Discount: 6,oprice: "42,000" , price: '35,500' },
...
export const imageTop:image[] =[
    {id:1 , image:cheese},
    {id:2 , image:khame},
    {id:3 , image:mast},
]

export const imageBottom:image[] =[
    {id:4 , image:dogh},
    {id:5 , image:mosir},
    {id:6 , image:fruit},
]